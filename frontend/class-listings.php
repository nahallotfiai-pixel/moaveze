...
class Moaveze_Listings {
    ...
    private function render_card($post_id, $style = 'modern') {
        ...
        <div class="moaveze-card moaveze-card-<?php echo esc_attr($style); ?>"
            ...
            <?php if (get_option('moaveze_addon_compare_listings') === 'yes') : ?>
                <label class="moaveze-compare-checkbox" title="افزودن به مقایسه">
                    <input type="checkbox" class="moaveze-compare-input" data-id="<?php echo esc_attr($post_id); ?>">
                    <span>مقایسه</span>
                </label>
            <?php endif; ?>
